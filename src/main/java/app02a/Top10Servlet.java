...
public class Top10Servlet extends HttpServlet {
    ...
    public void init() throws ServletException{
        ...
        londonAttractions.add("Natual History Museum");
        ...
        parisAttractions.add("Eiffel Towel");
        parisAttractions.add("Notre Dame");
        parisAttractions.add("The Louvre");
        parisAttractions.add("Chapms Elysees");
    ...
    public void showAttractions(HttpServletRequest request,HttpServletResponse response,String city)throws ServletException,IOException{
        int page = 1;
